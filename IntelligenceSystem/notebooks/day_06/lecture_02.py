...
# - 배깅의 경우 앙상블을 구성하는 머신러닝 모델은 1개를 사용함
# - 다만 각각의 모델이 학습하는 데이터는 무작위 추출 방법(bootstrapping)으로 처리하여
#   다수개의 모델이 서로 다른 관점의 학습을 진행할 수 있도록 처리
...
"""
base_estimator : 예측 모델 단 하나
max_smaples : 교수는 0.85에서 시작
"""
model = BaggingClassifier(base_estimator=estimator, n_estimators=10, max_samples=1.0, max_features=1.0,
